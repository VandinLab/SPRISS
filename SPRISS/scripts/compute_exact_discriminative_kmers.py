...
output = open("discriminative_kmers/exact_discriminative_kmers_"+dataset1_name+"-"+dataset2_name+"_"+str(theta*(10**8))+".txt",'w')

print("Computing exact discriminative k-mers " + dataset1_name + "-" + dataset2_name + " ...")
dataset1_path = dataset1_name +"/exact_kmc_freqkmers_"+ str(theta*(10**8))+"_ordered.txt"
dataset2_path = dataset2_name +"/exact_kmc_freqkmers_"+ str(theta*(10**8))+"_div2_ordered.txt"			
