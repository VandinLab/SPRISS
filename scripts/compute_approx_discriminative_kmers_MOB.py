...
t = int(sys.argv[6])
output = open("MOBdatasets/approx_discriminative_kmers_"+dataset1_name+"-"+dataset2_name+"_"+str(theta*(10**8))+".txt",'w')
k=31
print("Computing approx discriminative k-mers " + dataset1_name + "-" + dataset2_name + " ...")
dataset1_path = "MOBdatasets/" + dataset1_name + "_kmc_" + str(k) + "-mers_" + str(t) + "_ordered.txt"
dataset2_path = "MOBdatasets/" + dataset2_name + "_kmc_" + str(k) + "-mers_" + str(t) + "_ordered.txt"
